...
INSERT INTO home(id, type, name, price, rented) VALUES (1, 'huis', 'villa happiness', 1500, 'rented');
INSERT INTO home(id, type, name, price, rented) VALUES (2, 'appartament', 'cozy rooms', 750, 'rented');
INSERT INTO booking( id, finish_date, status, type_booking, home_id, price) VALUES (1, '2023, 03, 15','status', 'geboekt', 1, 1500);
INSERT INTO booking( id, finish_date, status, type_booking, home_id, price) VALUES (2, '2023, 03, 21','status', 'geboekt', 2, 750);
INSERT INTO receipt(id, klant, price) VALUES (1, 'Jaap Job', 1500);
INSERT INTO receipt(id, klant, price) VALUES (2, 'Melinda Carlisle', 750);
INSERT INTO cancellation(id, finish_date, status, type_booking, price, name, home_id) VALUES (1, '2023,03,15', 'status', 'niet geboekt', 1500, 'Dion', 1);
INSERT INTO cancellation(id, finish_date, status, type_booking, price, name, home_id) VALUES (2, '2023,03,21', 'status', 'niet geboekt', 750, 'Charlie', 2);
...
-- INSERT INTO boekingen (id, finish_date, status, type_boeking, home, price) VALUES (1, '2022, 03, 15',  'status', 'geboekt',  home1, 1500);
-- INSERT INTO boekingen (id, finish_date, status, type_boeking, home, price) VALUES (2, '2022, 03, 21', 'status', 'geboekt',  home2, 750);
