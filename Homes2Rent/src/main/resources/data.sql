...
INSERT INTO woningen(id, type, name, price, rented) VALUES (2, 'appartamnet', 'cozy rooms', 750, 'rented');
INSERT INTO boekingen( id, finish_date, status, type_boeking, woning_id, price) VALUES (1, '2022, 03, 15','status', 'geboekt', 1, 1500);
INSERT INTO boekingen( id, finish_date, status, type_boeking, woning_id, price) VALUES (2, '2022, 03, 21','status', 'geboekt', 2, 750);
...
INSERT INTO annulering(id, finish_date, status, type_boeking, price, name, woning_id) VALUES (1, '2022,03,15', 'status', 'niet geboekt', 1500, 'Dion', 1);
INSERT INTO annulering(id, finish_date, status, type_boeking, price, name, woning_id) VALUES (2, '2022,03,21', 'status', 'niet geboekt', 750, 'Charlie', 2);
